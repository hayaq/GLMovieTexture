...
-(void)initAssetReader{
	...
	CMTime tm = CMTimeMake((int64_t)(currentTime*30000), 30000);
	[assetReader setTimeRange:CMTimeRangeMake(tm,asset.duration)];
